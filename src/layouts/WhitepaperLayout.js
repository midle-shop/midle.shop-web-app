...
const BreadcrumbWhitepaperPage = Loadable({
  loader: () => import('../components/breadcrumbs/BreadcrumbWhitepaperPage'),
  loading: () => null,
});
...
class WhitepaperLayout extends Component {
  constructor(props) {
    super(props);
    this.state = {
      document: 'whitepaper',
  ...
  render() {
    //console.log('|--> WhitepaperLayout render')
    const { t } = this.props;

    return (
      <MainContainer
        breadcrumb={BreadcrumbWhitepaperPage}
        footer={Footer}
      >
        <Helmet>
          <title>{t('menu.whitepaper')} | {t('projectName')}</title>
        </Helmet>
        {
...
export default hot(module)(
  connect(mapStateToProps)(
    translate('main')(WhitepaperLayout)
  )
);
