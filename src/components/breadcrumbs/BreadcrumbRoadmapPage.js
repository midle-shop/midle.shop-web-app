...
const BreadcrumbRoadmapPage = (props) => {
  //console.log('|--> BreadcrumbRoadmapPage render')
  ...
  return(
    <Breadcrumb style={{marginTop: '1em', marginBottom: '1em',}} size={props.size ? props.size : undefined}>
      ...
      <Breadcrumb.Divider />
      <Breadcrumb.Section active>{t('menu.roadmap')}</Breadcrumb.Section>
    </Breadcrumb>
  );
}
...
export default hot(module)(
  connect(mapStateToPropsBC)(
    translate('main')(BreadcrumbRoadmapPage)
  )
);
